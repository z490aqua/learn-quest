...
global.seqLayer3 = layer_get_id("LayerSequence3");
global.seqSurf = -1;
...
layer_script_begin(global.seqLayer3, sequence_layer_draw_begin);
layer_script_end(global.seqLayer3, sequence_layer_draw_end);
